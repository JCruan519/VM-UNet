...
class setting_config:
    ...
    datasets_name = 'AbdomenAtlas' 
    input_size_h = 224
    input_size_w = 224
    if datasets_name == 'AbdomenAtlas':
        data_path = './VM_UNet/VM-UNet/data/AbdomenAtlas/train_npz_0.8/'
        datasets = AbdomenAtlas_dataset
        list_dir = './VM_UNet/VM-UNet/data/AbdomenAtlas/lists/small_lists_AbdomenAtlas/'
        volume_path = './VM_UNet/VM-UNet/data/AbdomenAtlas/test_vol_h5_0.2/'
        # volume_path = '/home/guanjiale/VM_UNet/VM-UNet/data/AbdomenAtlas/BDMAP'
    else:
    ...
    # work_dir = 'VM-UNet_copy/results/vmunet_AbdomenAtlas_Thursday_15_August_2024_21h_02m_43s/'
